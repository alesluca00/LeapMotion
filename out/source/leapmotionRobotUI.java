...
public class leapmotionRobotUI extends PApplet {
...
public String setTextMouseButton(String text)
{
  switch(text)
  {
...
public int getKeyEventByMouseButton(int mouseButton1)
{
...
public int getKeyCodeByText(String text) {
  int keyEvent=0;
...
public int[] getArrayByName(String gesture)
{
  switch(gesture)
  {
...
// ======================================================
// 1. Fist Pose
public void fistPose(Hand hand)
{
...
public void victoryPose(Hand hand)
{  
...
public int[] mapArray(int[] gesture, int keyCode1, int keyCode2, int keyCode3)
{
...
public void mapKey( String name, int keyCode1, int keyCode2, int keyCode3) {
...
public void doGesture(int[] gesture)
{
  ...
  public void settings() {  size(970, 980); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "leapmotionRobotUI" };
    if (passedArgs != null) {
